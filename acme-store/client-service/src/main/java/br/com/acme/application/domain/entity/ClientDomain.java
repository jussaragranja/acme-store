...
public class ClientDomain {
    ...
    public List<CardDomain> getCardsAvailable(IListCardAvailableClientRepository iListCardAvailableClientRepository){
        return iListCardAvailableClientRepository.execute(String.valueOf(this.income));
    }
